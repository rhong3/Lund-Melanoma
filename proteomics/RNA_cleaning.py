...
RNA_raw = pd.read_excel('./Transcriptome/Transcriptomics_final.214.allMm.not.meancentered_rounded.xlsx',
...
wona_clinical = pd.read_csv('wona_clinical.tsv', sep='\t', header=0, index_col=0)
...
RNA_raw.to_csv('./Transcriptome/Clean_transcriptome.tsv', sep='\t', index=True, header=True)
wna_clinical.to_csv('./Transcriptome/T_wna_clinical.tsv', sep='\t', index=True, header=True)
wona_clinical.to_csv('./Transcriptome/T_wona_clinical.tsv', sep='\t', index=True, header=True)
