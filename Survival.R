...
BRAF_clinical = BRAF_clinical[!is.na(BRAF_clinical$DSS.DAYS.v2...days.from.sample.collection..surgery..to.death.or.censoring),]
...
proteomics = data.matrix(proteomics[-c(26:7984),])
...
Core_clinical = subset(Core_clinical, Core_clinical$Alive.2016.12.05_nan == 0)
Core_clinical$censor = abs(Core_clinical$Alive.2016.12.05_alive - 2)
Core_clinical = Core_clinical[!is.na(Core_clinical$OS.DAYS.....days.from.primary.diagnosis.to.death.or.censoring),]
